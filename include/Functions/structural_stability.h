...
double compute_critical_Delta(Metaparameters, ntype, delta_solver);

double estimate_delta_crit_from_interval(const nvector&, const nvector&, const Metaparameters&,delta_solver);
