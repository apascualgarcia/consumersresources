...
\vspace{-120pt}
\hspace{-0.1\linewidth}
\subfloat[]{\includegraphics[width=1.2\linewidth]{{feasibility_region_wt_wc_NR50_NS25_Nest0.6_Conn0.3344}.pdf}}

\vspace{-68pt}
\hspace{-0.1\linewidth}
\subfloat[]{\includegraphics[width=1.2\linewidth]{{feasibility_region_wt_wc_NR50_NS25_Nest0.35_Conn0.2296}.pdf}}

\vspace{-68pt}
\hspace{-0.1\linewidth}
\subfloat[]{\includegraphics[width=1.2\linewidth]{{feasibility_region_wt_NR50_NS25_Nest0.15_Conn0.12}.pdf}}
\caption{To be compared with Fig.\ref{fig : feasibility results fully feasible volume different consumption matrices} Sort colorbar}
\end{figure}
