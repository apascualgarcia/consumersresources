...
filename='data_output/critical_dynamical_syntrophies_NR50_NS25_backup'
...
critical_alpha = np.genfromtxt(filename+'.out', usecols=[1,2,3,4])[:2]
matrix_name = np.genfromtxt(filename+'.out', usecols=[0], dtype=np.dtype('U'))[:2]
