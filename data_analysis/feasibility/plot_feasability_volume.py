...
data_folder='./feasibility'
plot_folder='./plots'
matrices_folder='optimal_matrices/consumption/Nr25_Nc25'
filename='feasibility_NR25_NS25_100_points_full_rank_opt_consumption_mat_NR25_NS25_random_structure_optimal_LRI_alpha0=0'
mat_index=4
mat_index_2=14
...
title_axis+=r', \eta_G='+str(nestedness[mat_index])
title_axis+=r', \kappa_G='+str(connectance[mat_index])
title_axis+='$'
...
print('Fitting for matrix Nest', nestedness[mat_index], ' Conn',connectance[mat_index], popt, pcov)
print('Expected coeff', exp_coeff[mat_index])
...
print('Fitting for matrix Nest', nestedness[mat_index_2], ' Conn',connectance[mat_index_2], popt, pcov)
print('Expected coeff', exp_coeff[mat_index_2])
...
title_axis=r'$\eta_G='+str(closest_element_in_list(nestedness[mat_index_2], all_nestedness))
title_axis+=r', \kappa_G='+str(closest_element_in_list(connectance[mat_index_2], all_connectance))+'$'
...
cbar.set_label(r'$\mathcal{F}\left((\gamma_0, S_0,0), G,0\right)$')
...
print('Fitting for common feasibility volume:', popt, pcov)
print('Expected:', min(exp_coeff))
