...
from common_functions import plot_points_as_area, get_fit_cfr, plot_feasibility_region_for_one_matrix
import os
...
#for i in range(len(feasibility_region[0][0])):
#    print(feasibility_region[:,:,i])
#plot_feasibility_region_for_one_matrix()
for i in range(26):
    print(feasibility_region[0,9,i,6::3][870])
