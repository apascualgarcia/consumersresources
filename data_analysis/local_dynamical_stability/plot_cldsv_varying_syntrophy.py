...
from common_functions import plot_points_as_area, get_fit_cfr, remove_strings_from_file
import os
...
for al_mo in alpha_mode:
    ...
    for a in alpha0:
        ...
        #remove_strings_from_file('optimal_matrices/consumption/Nr25_Nc25', file)
...
for k in range(len(local_dynamical_stability_region)):
    ...
    im=ax.tricontourf(triang, local_dynamical_stability_level, levels=levels, cmap='jet_r')
