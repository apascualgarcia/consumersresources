...
plotting_properties=dict({
    ...
    'width': 1,         # box width
    'data file': 'results/all_data_NR25_NS25_optmat_alpha=0.001_gamma=1_verbose-level=1.out', # location of the data file produced with compute_feasibility_data.py
