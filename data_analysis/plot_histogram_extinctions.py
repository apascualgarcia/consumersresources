...
def plot_histogram_for_matrix(nest, conn):
...
plot_histogram_for_matrix(nest=0.1, conn=0.0832)
plot_histogram_for_matrix(nest=0.25, conn=0.2336)
plot_histogram_for_matrix(nest=0.55, conn=0.2784)
plot_histogram_for_matrix(nest=0.55, conn=0.4176)
